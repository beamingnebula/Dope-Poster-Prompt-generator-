...
Use graphite black, warm paper white, and a single acidic lime accent. The subject should feel physically real and iconically strange: sculptural, tactile, sharply lit and carefully isolated. Add subtle offset-print grain, faint registration marks, measured alignment rules and microscopic catalog metadata. Typography is structural—large, compressed, partially masked by the hero object—with TEXT 1 as the dominant title and TEXT 2–TEXT 6 used only as quiet supporting information.

Mood: restrained underground luxury, quiet technical confidence, contemporary design annual. Avoid generic AI gloss, excessive neon, random objects, illegible text clutter and decorative gradients. Every element has a clear reason to exist.`
...
function App({ onOpenDestiny }: AppProps) {
  ...
  const [layout, setLayout] = useState('Asymmetric Swiss grid')
